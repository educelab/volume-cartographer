...
int main(){
    ...
    // Init Shape Meshes
    VC_MeshType::Pointer in_PlaneMesh, in_ArchMesh, in_CubeMesh, in_SphereMesh, in_ConeMesh;
    ...
    while (ShapeCounter < 5){
        ...
        if (ShapeCounter == 0) {
            ...
            //call rayTrace()
            TraceResults = volcart::meshing::rayTrace(in_PlaneMesh, TraceDir, Width, Height, UVMap);
        ...
        //prepare to write cube data
            ...
            TraceResults = volcart::meshing::rayTrace(in_CubeMesh, TraceDir, Width, Height, UVMap);
            NumberOfPoints = TraceResults.size();
        ...
        //prepare to write arch data
            ...
            TraceResults = volcart::meshing::rayTrace(in_ArchMesh, TraceDir, Width, Height, UVMap);
            NumberOfPoints = TraceResults.size();
        ...
        //prepare to write sphere
            ...
            TraceResults = volcart::meshing::rayTrace(in_SphereMesh, TraceDir, Width, Height, UVMap);
            NumberOfPoints = TraceResults.size();
        ...
        //prepare to write cone data
            ...
            TraceResults = volcart::meshing::rayTrace(in_ConeMesh, TraceDir, Width, Height, UVMap);
            NumberOfPoints = TraceResults.size();
        ...
        for (int point = 0; point < NumberOfPoints; point++) {
            ...
            // x y z nx ny nz
            MeshOutputFileStream << TraceResults[point](0) << " "
            << TraceResults[point](1)  << " "
            << TraceResults[point](2)  << " "
            << TraceResults[point](3)  << " "
            << TraceResults[point](4)  << " ";
            ...
            if (TraceResults[point](5) == -0) {
                ...
                MeshOutputFileStream << TraceResults[point](5) << " " << std::endl;
            }
        }
