...
int main(int argc, char* argv[])
{
    ...
    reader2->Update();
    volcart::MeshType::Pointer uvmap = volcart::MeshType::New();
    ...
    double u, v;
    for (volcart::CellIterator cell = uvmap->GetCells()->Begin();
         cell != uvmap->GetCells()->End(); ++cell) {

        for (volcart::PointsInCellIterator pt = cell.Value()->PointIdsBegin();
