...
struct itk2vtkPlaneFixture {
    ...
    volcart::MeshType::Pointer _in_Mesh;
...
struct NoNormalsFixture {
    NoNormalsFixture()
    {
        _itk_Mesh = volcart::MeshType::New();

        volcart::PointType p0, p1, p2, p3;
        p0[0] = 0.0;
        p0[1] = 0.0;
        p0[2] = 0.0;
        p1[0] = 1.0;
        ...
        volcart::CellType::CellAutoPointer cell_0;
        volcart::CellType::CellAutoPointer cell_1;
        cell_0.TakeOwnership(new volcart::TriangleType);
        cell_1.TakeOwnership(new volcart::TriangleType);
    ...
    volcart::MeshType::Pointer _itk_Mesh;
};
...
struct vtk2itkPlaneFixture {
    ...
    vtk2itkPlaneFixture()
    {
        ...
        _out_Mesh = volcart::MeshType::New();
    ...
    volcart::MeshType::Pointer _out_Mesh;
    ...
    itk2vtkPlaneFixture)
{
    ...
    for (vtkIdType pnt_id = 0; pnt_id < _out_Mesh->GetNumberOfPoints();
        ...
        volcart::PixelType out_NormalTuple =
            out_PlanePointNormals->GetTuple(pnt_id);
    ...
    vtk2itkPlaneFixture)
{
    ...
    // Normals //
    volcart::PointsInMeshIterator point = _out_Mesh->GetPoints()->Begin();
    for (int p = 0; point != _out_Mesh->GetPoints()->End(); ++p, ++point) {
        volcart::PixelType _out_MeshNormal;
    ...
    volcart::CellIterator _out_MeshCell = _out_Mesh->GetCells()->Begin();
    ...
    while (_out_MeshCell != _out_Mesh->GetCells()->End()) {
        ...
        volcart::PointsInCellIterator _out_MeshPointId =
...
BOOST_FIXTURE_TEST_CASE(MeshWithNoNormals, NoNormalsFixture)
{
    ...
    // VTK to ITK
    volcart::MeshType::Pointer itk_Mesh2 = volcart::MeshType::New();
    ...
    // ITK Quad to ITK
    itk_Mesh2 = volcart::MeshType::New();
