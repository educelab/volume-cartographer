...
struct SmoothNormalsFixture {
    ...
    volcart::MeshType::Pointer _in_PlaneMesh, _in_CubeMesh, _in_SphereMesh,
        _in_ArchMesh, _in_ConeMesh;
    volcart::MeshType::Pointer _out_SmoothedPlaneMesh, _out_SmoothedCubeMesh,
    ...
    std::vector<volcart::Vertex> _SavedPlanePoints, _SavedCubePoints,
        _SavedArchPoints, _SavedSpherePoints, _SavedConePoints;
    std::vector<volcart::Cell> _SavedPlaneCells, _SavedCubeCells,
    ...
    CompareFixtureSmoothedPlaneWithSavedPlaneTest, SmoothNormalsFixture)
{
    ...
    volcart::PointsInMeshIterator point =
        _out_SmoothedPlaneMesh->GetPoints()->Begin();
    ...
    // cells
    volcart::CellIterator out_PlaneCell =
        _out_SmoothedPlaneMesh->GetCells()->Begin();
    ...
    while (out_PlaneCell != _out_SmoothedPlaneMesh->GetCells()->End()) {
        ...
        volcart::PointsInCellIterator out_PlaneMeshPointId =
    ...
    CompareFixtureSmoothedCubeWithSavedCubeTest, SmoothNormalsFixture)
{
    ...
    // normals
    volcart::PointsInMeshIterator point =
        _out_SmoothedCubeMesh->GetPoints()->Begin();
    ...
    // cells
    volcart::CellIterator out_CubeCell =
        _out_SmoothedCubeMesh->GetCells()->Begin();
    ...
    while (out_CubeCell != _out_SmoothedCubeMesh->GetCells()->End()) {
        ...
        // Initialize Iterators for Points in a Cell
        volcart::PointsInCellIterator out_CubeMeshPointId =
    ...
    CompareFixtureSmoothedSphereWithSavedSphereTest, SmoothNormalsFixture)
{
    ...
    // normals
    volcart::PointsInMeshIterator point =
        _out_SmoothedSphereMesh->GetPoints()->Begin();
    ...
    // cells
    volcart::CellIterator out_SphereCell =
    ...
    while (out_SphereCell != _out_SmoothedSphereMesh->GetCells()->End()) {
        ...
        // Initialize Iterators for Points in a Cell
        volcart::PointsInCellIterator out_SphereMeshPointId =
    ...
    CompareFixtureSmoothedArchWithSavedArchTest, SmoothNormalsFixture)
{
    ...
    // normals
    volcart::PointsInMeshIterator point =
        _out_SmoothedArchMesh->GetPoints()->Begin();
    ...
    volcart::CellIterator out_ArchCell =
        _out_SmoothedArchMesh->GetCells()->Begin();
    ...
    while (out_ArchCell != _out_SmoothedArchMesh->GetCells()->End()) {
        ...
        // Initialize Iterators for Points in a Cell
        volcart::PointsInCellIterator out_ArchMeshPointId =
    ...
    CompareFixtureSmoothedConeWithSavedConeTest, SmoothNormalsFixture)
{
    ...
    // normals
    volcart::PointsInMeshIterator point =
        _out_SmoothedConeMesh->GetPoints()->Begin();
    ...
    // Initialize Cell Iterators
    volcart::CellIterator out_ConeCell =
        _out_SmoothedConeMesh->GetCells()->Begin();
    ...
    while (out_ConeCell != _out_SmoothedConeMesh->GetCells()->End()) {
        ...
        // Initialize Iterators for Points in a Cell
        volcart::PointsInCellIterator out_ConeMeshPointId =
...
BOOST_FIXTURE_TEST_CASE(SmoothWithZeroRadiusTest, SmoothNormalsFixture)
{
    ...
    volcart::MeshType::Pointer ZeroRadiusSmoothedMesh =
    ...
    for (auto point = _in_ArchMesh->GetPoints()->Begin();
        ...
        volcart::PixelType in_ArchNormal, ZeroRadiusNormal;
    ...
    // Initialize Cell Iterators
    volcart::CellIterator in_ArchCell = _in_ArchMesh->GetCells()->Begin();
    volcart::CellIterator ZeroRadiusSmoothedCell =
    ...
    while (in_ArchCell != _in_ArchMesh->GetCells()->End()) {
        ...
        // Initialize Iterators for Points in a Cell
        volcart::PointsInCellIterator in_ArchMeshPointId =
            in_ArchCell.Value()->PointIdsBegin();
        volcart::PointsInCellIterator ZeroRadiusMeshPointId =
