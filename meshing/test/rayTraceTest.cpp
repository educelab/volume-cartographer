...
struct PlaneRayTraceFixture {
    ...
    std::vector<volcart::Vertex> _SavedPoints, _CurrentPoints;
    std::vector<volcart::Cell> _SavedCells, _CurrentCells;
};
...
struct CubeRayTraceFixture {
    ...
    volcart::MeshType::Pointer _in_CubeMesh;
...
struct ArchRayTraceFixture {
    ...
    volcart::MeshType::Pointer _in_ArchMesh;
...
struct ConeRayTraceFixture {
    ...
    volcart::MeshType::Pointer _in_ConeMesh;
