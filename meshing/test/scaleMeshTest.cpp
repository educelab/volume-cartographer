...
struct ScaledPlaneFixture {
    ...
    volcart::MeshType::Pointer _in_PlaneMesh,
        _in_PlaneMeshUsedForRegressionTest;
    volcart::MeshType::Pointer _out_PlaneMesh = volcart::MeshType::New();
    double _ScaleFactor;

    // used for regression testing
    volcart::MeshType::Pointer _out_PlaneMeshUsedForRegressionTest =
        volcart::MeshType::New();
    std::vector<volcart::Vertex> _SavedPlanePoints;
    std::vector<volcart::Cell> _SavedPlaneCells;
};
...
struct ScaledCubeFixture {
    ...
    volcart::MeshType::Pointer _in_CubeMesh, _in_CubeMeshUsedForRegressionTest;
    volcart::MeshType::Pointer _out_CubeMesh = volcart::MeshType::New();
    volcart::shapes::Cube _Cube;
    double _ScaleFactor;

    volcart::MeshType::Pointer _out_CubeMeshUsedForRegressionTest =
        volcart::MeshType::New();
    std::vector<volcart::Vertex> _SavedCubePoints;
    std::vector<volcart::Cell> _SavedCubeCells;
};
...
struct ScaledArchFixture {
    ...
    volcart::MeshType::Pointer _in_ArchMesh, _in_ArchMeshUsedForRegressionTest;
    volcart::MeshType::Pointer _out_ArchMesh = volcart::MeshType::New();
    volcart::shapes::Arch _Arch;
    double _ScaleFactor;

    volcart::MeshType::Pointer _out_ArchMeshUsedForRegressionTest =
        volcart::MeshType::New();
...
struct ScaledSphereFixture {
    ...
    volcart::MeshType::Pointer _in_SphereMesh,
        _in_SphereMeshUsedForRegressionTest;
    volcart::MeshType::Pointer _out_SphereMesh = volcart::MeshType::New();
    volcart::shapes::Sphere _Sphere;
    double _ScaleFactor;

    volcart::MeshType::Pointer _out_SphereMeshUsedForRegressionTest =
        volcart::MeshType::New();
    std::vector<volcart::Vertex> _SavedSpherePoints;
    std::vector<volcart::Cell> _SavedSphereCells;
};
...
struct ScaledConeFixture {
    ...
    volcart::MeshType::Pointer _in_ConeMesh, _in_ConeMeshUsedForRegressionTest;
    volcart::MeshType::Pointer _out_ConeMesh = volcart::MeshType::New();
    volcart::shapes::Cone _Cone;
    double _ScaleFactor;

    volcart::MeshType::Pointer _out_ConeMeshUsedForRegressionTest =
        volcart::MeshType::New();
    std::vector<volcart::Vertex> _SavedConePoints;
    std::vector<volcart::Cell> _SavedConeCells;
};
    ...
    ConfirmInputPlaneMeshIsUnchangedAfterScalingTest, ScaledPlaneFixture)
{
    ...
    // init new plane mesh
    volcart::MeshType::Pointer NewPlaneMesh = _Plane.itkMesh();
    ...
    // Compare Cells
    volcart::CellIterator in_PlaneMeshCell = _in_PlaneMesh->GetCells()->Begin();
    volcart::CellIterator NewPlaneMeshCell = NewPlaneMesh->GetCells()->Begin();

    while (in_PlaneMeshCell != _in_PlaneMesh->GetCells()->End()) {

        // Initialize Iterators for Points in a Cell
        volcart::PointsInCellIterator in_PlaneMeshPointId =
            in_PlaneMeshCell.Value()->PointIdsBegin();
        volcart::PointsInCellIterator NewPlaneMeshPointId =
    ...
    CompareSavedAndFixtureScaledPlaneMesh, ScaledPlaneFixture)
{
    ...
    volcart::CellIterator _out_PlaneMeshUsedForRegressionTestCell =
    ...
    while (_out_PlaneMeshUsedForRegressionTestCell !=
        ...
        volcart::PointsInCellIterator
            _out_PlaneMeshUsedForRegressionTestPointId =
                _out_PlaneMeshUsedForRegressionTestCell.Value()
                    ->PointIdsBegin();
...
BOOST_FIXTURE_TEST_CASE(CompareSavedAndFixtureScaledCubeMesh, ScaledCubeFixture)
{
    ...
    for (; point != _out_CubeMeshUsedForRegressionTest->GetPoints()->End();
        ...
        volcart::PixelType _out_CubeMeshUsedForRegressionTestNormal;
    ...
    volcart::CellIterator _out_CubeMeshUsedForRegressionTestCell =
...
BOOST_FIXTURE_TEST_CASE(CompareSavedAndFixtureScaledArchMesh, ScaledArchFixture)
{
    ...
    for (; point != _out_ArchMeshUsedForRegressionTest->GetPoints()->End();
        ...
        volcart::PixelType _out_ArchMeshUsedForRegressionTestNormal;
    ...
    volcart::CellIterator _out_ArchMeshUsedForRegressionTestCell =
    ...
    CompareSavedAndFixtureScaledSphereMesh, ScaledSphereFixture)
{
    ...
    for (; point != _out_SphereMeshUsedForRegressionTest->GetPoints()->End();
        ...
        volcart::PixelType _out_SphereMeshUsedForRegressionTestNormal;
    ...
    volcart::CellIterator _out_SphereMeshUsedForRegressionTestCell =
    ...
    while (_out_SphereMeshUsedForRegressionTestCell !=
        ...
        volcart::PointsInCellIterator
            _out_SphereMeshUsedForRegressionTestPointId =
                _out_SphereMeshUsedForRegressionTestCell.Value()
                    ->PointIdsBegin();
...
BOOST_FIXTURE_TEST_CASE(CompareSavedAndFixtureScaledConeMesh, ScaledConeFixture)
{
    ...
    for (; point != _out_ConeMeshUsedForRegressionTest->GetPoints()->End();
        ...
        volcart::PixelType _out_ConeMeshUsedForRegressionTestNormal;
    ...
    volcart::CellIterator _out_ConeMeshUsedForRegressionTestCell =
