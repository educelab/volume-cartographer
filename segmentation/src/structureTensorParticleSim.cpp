...
namespace volcart {
    namespace segmentation {
        volcart::OrderedPointSet<volcart::Point3d> structureTensorParticleSim(std::vector<volcart::Point3d> segPath, const VolumePkg& volpkg, double gravity_scale, int threshold, int endOffset) {
