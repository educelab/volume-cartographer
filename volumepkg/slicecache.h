...
#ifndef _VOLUMEPKG_SLICEitems_H_
#define _VOLUMEPKG_SLICEitems_H_
...
/*
 * A cache of VolumePkg slices implementing the least-recently-used algorithm
 ...
 * necesary, this should probably be profiled
 *
...
public:
    ...
    SliceCache() : size_(kDefaultSize) { }

    SliceCache(const size_t size) : size_(size) {  }
