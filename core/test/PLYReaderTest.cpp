...
{
    volcart::io::PLYReader2 reader("PLYReader2_arch.ply");
    reader.read();
...
{
    volcart::io::PLYReader2 reader("PLYReader2_plane.ply");
    reader.read();
...
{
    volcart::io::PLYReader2 reader("PLYReader2_cone.ply");
    reader.read();
...
{
    volcart::io::PLYReader2 reader("PLYReader2_sphere.ply");
    reader.read();
