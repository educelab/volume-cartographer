 ...
 *           can be written into obj file by common/io/objWriter.cpp. This test
 * is     *
...
struct WriteMeshUsingOBJWriterFixture {
    ...
    volcart::MeshType::Pointer _in_PlaneITKMesh;
    ...
    WriteMeshUsingOBJWriterFixture)
{
    ...
    volcart::PointsInMeshIterator point =
        _in_PlaneITKMesh->GetPoints()->Begin();
    for (; point != _in_PlaneITKMesh->GetPoints()->End(); ++point) {

        volcart::PixelType _in_PlaneITKMeshNormal;
    ...
    volcart::CellIterator _in_PlaneITKMeshCell =
    ...
    while (_in_PlaneITKMeshCell != _in_PlaneITKMesh->GetCells()->End()) {
        ...
        volcart::PointsInCellIterator _in_PlaneITKMeshPointId =
