...
namespace io {
  ...
  public:
    objWriter();
    objWriter( boost::filesystem::path outputPath, MeshType::Pointer mesh );
    objWriter( boost::filesystem::path outputPath, MeshType::Pointer mesh, volcart::UVMap uvMap, cv::Mat uvImg);
