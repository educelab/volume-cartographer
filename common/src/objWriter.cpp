...
namespace volcart {
    ...
    objWriter::objWriter( fs::path outputPath, MeshType::Pointer mesh ) {
        _outputPath = outputPath;
        _mesh = mesh;
    };

    objWriter::objWriter( fs::path outputPath, MeshType::Pointer mesh, volcart::UVMap uvMap, cv::Mat uvImg ) {
        _outputPath = outputPath;
        _mesh = mesh;
        _textCoords = uvMap;
        _texture = uvImg;
