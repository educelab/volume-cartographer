...
void AngleBasedFlattening::setABFMaxIterations(int i) { _maxABFIterations = i; };
...
double AngleBasedFlattening::_computeGradientAlpha(volcart::HalfEdgeMesh::FacePtr f, volcart::HalfEdgeMesh::EdgePtr e0) {
  volcart::HalfEdgeMesh::VertPtr v0 = e0->vert, v1 = e0->next->vert, v2 = e0->next->next->vert;
...
double AngleBasedFlattening::_computeSinProduct( volcart::HalfEdgeMesh::VertPtr v ) {
...
double AngleBasedFlattening::_computeSinProduct( volcart::HalfEdgeMesh::VertPtr v, volcart::HalfEdgeMesh::IDType a_id) {
  volcart::HalfEdgeMesh::EdgePtr e0, e1, e2;
  double sin1, sin2;
  sin1 = sin2 = 1.0;
...
bool   AngleBasedFlattening::_invertMatrix() {
  ...
  for( auto f = _heMesh.getFace(0); f; f = f->nextlink, ++counter ) {
    ...
    volcart::HalfEdgeMesh::EdgePtr e0 = f->edge, e1 = e0->next, e2 = e1->next;
    volcart::HalfEdgeMesh::VertPtr v0 = e0->vert, v1 = e1->vert, v2 = e2->vert;
...
std::pair<volcart::HalfEdgeMesh::IDType, volcart::HalfEdgeMesh::IDType> AngleBasedFlattening::_getMinMaxPointIDs() {
