...
///// Constructors /////
LeastSquaresConformalMapping::LeastSquaresConformalMapping( MeshType::Pointer input ) : _mesh(input) {
  _fillEigenMatrices();
};

///// Input/Output /////
// Set input mesh
void LeastSquaresConformalMapping::setMesh( MeshType::Pointer input ) {
  _emptyEigenMatrices();
  _mesh = input;
  _fillEigenMatrices();
}
...
// Get output as mesh
MeshType::Pointer LeastSquaresConformalMapping::getMesh() {
