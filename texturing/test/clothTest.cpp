...
struct CreateArchClothUVFixture {
    ...
    volcart::MeshType::Pointer _out_Mesh_unfurl, _out_Mesh_collide,
        _out_Mesh_final;
    ...
    std::vector<volcart::Vertex> _SavedPoints_unfurl;
    std::vector<volcart::Cell> _SavedCells_unfurl;

    std::vector<volcart::Vertex> _SavedPoints_collide;
    std::vector<volcart::Cell> _SavedCells_collide;

    std::vector<volcart::Vertex> _SavedPoints_final;
    std::vector<volcart::Cell> _SavedCells_final;
};
